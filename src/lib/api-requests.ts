...
import { GetMerchantLicenceApiResponse } from '../app/api/ikas/get-merchant-licence/route';
...
export const ApiRequests = {
  ikas: {
    ...
    getMerchantLicence: (token: string) =>
      makeGetRequest<GetMerchantLicenceApiResponse>({ url: '/api/ikas/get-merchant-licence', token }),
  },
};
